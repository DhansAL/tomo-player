...
/**
 *
 * Checks if there is any collection object in Local storage which is to be consumed by MediaSubs component.
 * gets the files from the selected collection object and provides the file path string via
 * **context provider
 *
 * @fix
 * fix zustand store for this
 *
 */
...
export const Collections = () => {
    ...
    const [currentCollection, setCurrentCollection] =
        createSignal<FileFolderServed[]>(null);
    onMount(() => {
    ...
    return (
        <div>
            <div
                class="overflow-scroll  scrollbar-primary "
                style={{ background: "#2e3b4e", height: "92vh" }}
            >
                        ...
                        <>
                            <div class="m-3 p3">
                                ...
                                <span class="text-light">
                                    You can add shows in overview section
                                </span>
                            </div>
                        </>
                    ) : (
